...
import site.xiaokui.blog.entity.enums.MenuStatusEnum;
import site.xiaokui.blog.entity.enums.MenuTypeEnum;
...
public class MenuController extends AbstractController {
     ...
     */
    @RequiresPermissions(MENU_PREFIX + ConstantController.ADD)
    ...
    public ResultEntity add(String name, Long parentId, @RequestParam(required = false) String parentName,
        ...
        if (icon != null && icon.startsWith(UserConstants.ICON_START_FLAG)) {
     ...
     * 跳转到菜单详情列表页面
     */
    @RequiresPermissions(MENU_PREFIX + ConstantController.EDIT)
     ...
     * 删除菜单
     */
    @RequiresPermissions(MENU_PREFIX + ConstantController.REMOVE)
