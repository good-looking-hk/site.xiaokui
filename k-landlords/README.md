本项目改写自开源项目:https://github.com/ainilili/ratel

为了帮助理解Netty在游戏中的应用，自己重复造了一个轮子，本轮子旨在个人学习，不存在对原项目的不认同

本项目技术栈：Netty + Protobuf + 事件驱动架构 + 斗地主规则算法

感谢原作者的开源项目，感谢原作者的无私分享、无私奉献，谢谢！

=========== 以下为原项目的 README.md 内容，未做任何删改 ===========
