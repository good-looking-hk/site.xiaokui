...
public abstract class BaseFileHelper {
     ...
     * 获取用户目录的File构造字符串
     */
    public String getUserDir(Long userId) {
     ...
     * 获取用户临时目录的File字符串
     */
    protected String getTempDir(Long userId) {
     ...
     * 获取用户临时目录文件的File字符串
     */
    private String getTempFile(Long userId, String fullName) {
     ...
     */
    public File createTempFile(Long userId, String fullName) {
     ...
     * 没有找到则返回null
     */
    public File findTempFile(Long userId, String fullName) {
        String path = getTempFile(userId, fullName);
        File file = new File(path);
     ...
     * 会主动创建目录结构
     */
    public File locateFile(Long userId, String fullName) {
     ...
     */
    public File locateFile(Long userId, String dir, String fullName) {
