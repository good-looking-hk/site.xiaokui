...
import site.xiaokui.module.sys.user.entity.OnlineUser;
...
public class OnlineController {
    ...
    public List<OnlineUser> list() {
        ...
        for (Session session : sessions) {
            SimplePrincipalCollection principalCollection = (SimplePrincipalCollection) session.getAttribute(SHIRO_USER_SESSION_KEY);
