...
import static site.xiaokui.base.constant.BaseConstants.ROLE_ADMIN;
import static site.xiaokui.base.constant.BaseConstants.ROLE_USER;
...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        // 超级管理员是最大的，因此拥有所有角色
        if (BaseConstants.ROLE_SUPER_ADMIN.equals(roleName)) {
