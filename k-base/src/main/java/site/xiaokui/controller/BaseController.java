...
import site.xiaokui.module.user.entity.enums.UserStatusEnum;
...
import static site.xiaokui.module.user.UserConstants.DEFAULT_DESCRIPTION;
import static site.xiaokui.module.user.UserConstants.DEFAULT_HEAD_IMG;
